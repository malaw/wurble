...
popupSlider = $(".popup-slider").bxSlider({
auto: false,
autoControls: false,
controls: true,
...
$('.gallery-popup-project .bx-wrapper .item img').css({'height':winHt-200,'width':'auto',});
}
})
...
$(window).resize(function(){
	var winWidth = $(window).width();
$('.gallery .gallery-holder .gallery-project  .item').css('width', winWidth)
popupSlider.destroySlider();
